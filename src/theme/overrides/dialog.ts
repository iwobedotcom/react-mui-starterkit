...
const Dialog = (
  ...
  MuiDialog?: { styleOverrides?: SxProps<Theme> };
  MuiDialogTitle?: { styleOverrides?: SxProps<Theme> };
  MuiDialogContent?: { styleOverrides?: SxProps<Theme> };
  MuiDialogActions?: { styleOverrides?: SxProps<Theme> };
} => ({
  MuiDialog: {
    styleOverrides: {
      paper: {
