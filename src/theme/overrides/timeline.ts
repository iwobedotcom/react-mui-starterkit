...
const Timeline = (
  ...
  MuiTimelineItem?: { styleOverrides?: SxProps<Theme> };
  MuiTimelineConnector?: { styleOverrides?: SxProps<Theme> };
  MuiTimelineContent?: { styleOverrides?: SxProps<Theme> };
  MuiTimelineDot?: { styleOverrides?: SxProps<Theme> };
} => ({
  MuiTimelineItem: {
    styleOverrides: {
      root: {
